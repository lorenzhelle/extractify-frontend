...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr_auto] justify-items-center min-h-screen p-2 pb-20 gap-10 sm:p-4 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center w-full max-w-5xl">
        <h1 className="text-2xl font-bold mb-4">
          Enhancing Query Understanding with LLM-Based Generative Entity Linking
        </h1>
